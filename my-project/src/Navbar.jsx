    ...
    <>
      <nav className="flex p-8 ml-3 justify-between border-b md:border md:border-b-2 ">
        ...
        <div className="flex md:flex-row">
          ...
          <button className="hidden md:block border hover:bg-red-400 rounded-full h-10 w-32 py-px bg-zoom-blue text-blue-100 font-bold text-lg font-sans">
            Sign in
          </button>
        </div>
        <div className="text-4xl text-blue-500 hover:text-red-200 md:hidden ">
          <RxHamburgerMenu />
        </div>
      </nav>
    </>
